...
#ifndef _DUAL_HID_DRIVER_H_
#define _DUAL_HID_DRIVER_H_

#include "gpdriver.h"
#include "drivers/dualhid/DualHIDDescriptors.h"

class DualHIDDriver : public GPDriver {
public:
    ...
    void processPlayer2(Gamepad * gamepad2);
    
private:
    uint8_t last_report_p1[CFG_TUD_ENDPOINT0_SIZE] = { };
    uint8_t last_report_p2[CFG_TUD_ENDPOINT0_SIZE] = { };
    HIDReport hidReportP1;
    HIDReport hidReportP2;
    bool player2Enabled = false;
};

#endif // _DUAL_HID_DRIVER_H_